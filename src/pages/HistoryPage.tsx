  ...
  return (
    <div className="space-y-4">
      <SectionCard
        ...
        subtitle={
          mode === 'matrix'
            ? 'טבלה: בודקים × תאריך ומשמרת · תאריכים מימין (ישן) לשמאל (חדש)'
            : 'רשימה לפי תאריך (מהחדש לישן) · בוקר → צהריים → לילה'
        }
        actions={
          <div className="flex flex-wrap items-center gap-2">
            <div
              className="flex rounded-xl border border-line bg-surface p-0.5 text-xs"
              role="tablist"
