        ...
        <div className="space-y-5 text-sm leading-relaxed text-ink sm:text-[0.9375rem]">
          ...
          <section>
            ...
            <p className="text-ink-soft">
              ...
              שיבוץ מקומית). סיסמאות מנהלים נשמרות כהאש מוצפן בלבד. גישה
              למערכת מוגבלת למנהלים מורשים. יש להימנע משיתוף פרטי התחברות או
              ייצוא מידע מחוץ למעגל העבודה הנדרש.
            </p>
          </section>
